...
const AUTOMATIONS = [
  {
    ...
    prompt: [
      ...
      "Opening: after any birthday message, start with a simple greeting such as 'Hi, good morning team' or similar, then go straight into one short eco joke on the next line. Do not give the joke a heading or title. Do not call it a dad joke in the email. Vary the joke topic across reefs, seagrass, mangroves, compost, recycling, beaches, corals, fish, forests, weather, fieldwork, and conservation life; use turtles only occasionally.",
      ...
      "Global eco news: one short item only. Prefer the supplied Global eco news source. Include a clear 'Read more' link from the supplied source. Never use a news.google.com/rss/articles redirect link in the email. If only a search link is supplied, say it is a search link.",
  ...
  },
  {
    ...
    prompt: [
      ...
      "Look at Daniel's recently sent education outreach emails when Gmail read access is available, and use them to improve tone, structure and CTAs.",
  ...
  },
  {
    ...
    prompt: [
      ...
      "Use the Supabase cold-email CRM, marketing research and automation data.",
      "Look at Daniel's recently sent corporate outreach emails when Gmail read access is available, and use them to improve tone, structure and CTAs.",
  ...
  },
  {
    ...
    prompt: [
      ...
      "Use the Supabase cold-email CRM, marketing research and automation data.",
      "Look at Daniel's recently sent travel/partner outreach emails when Gmail read access is available, and use them to improve tone, structure and CTAs.",
      "Focus on travel websites, travel agents, volunteer travel platforms, gap-year companies, responsible tourism sites, travel media, career-break partners, influencers and collaboration partners.",
      "Do not use schools, universities, taska, tadika, day-care or general education leads for Travel Outreach.",
