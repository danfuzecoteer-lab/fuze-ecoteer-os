...
const AUTOMATIONS = [
  {
    ...
    prompt: [
      ...
      "Global eco news: one short item only. Prefer the supplied Global eco news source. Include a clear 'Read more' link from the supplied source. Never use a news.google.com/rss/articles redirect link in the email. If the supplied Read more link is a news.google.com/rss/articles URL, replace it with the publisher/source URL from the Source field, for example https://www.greenpeace.org. If only a search link is supplied, say it is a search link.",
