...
const AUTOMATIONS = [
  {
    ...
    prompt: [
      ...
      "Opening: after any birthday message, write one short eco joke. Do not call it a dad joke in the email. Vary the joke topic across reefs, seagrass, mangroves, compost, recycling, beaches, corals, fish, forests, weather, fieldwork, and conservation life; use turtles only occasionally.",
