...
const AUTOMATIONS = [
  {
    ...
    prompt: [
      ...
      "Global eco news: one short item only. Prefer the supplied Global eco news source. Include a clear 'Read more' link from the supplied source. If only a search link is supplied, say it is a search link.",
