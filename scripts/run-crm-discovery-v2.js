...
async function searchRows(segment, query, existing) {
  const prompt = [
    ...
    "For Malaysian companies search SMEs, manufacturers, hotels, tourism businesses, banks, professional firms, CSR/ESG teams, chambers and business directories. For schools search international, private, primary, secondary, boarding, Montessori, preschool and school-trip programmes.",
