# Outreach Draft Agents

These agents create Gmail drafts only. They must never send cold outreach automatically.

Every run should use the Supabase CRM, competitor research, price comparison data, market research, and automation outputs where available. The drafts should be ready for Daniel to review, edit, and send manually.

## Shared Rules

- Create 10 drafts per agent run when enough usable CRM leads exist.
...
Audience: schools, taska, tadika, universities, international schools, outdoor education leads and service-learning teams.

Focus countries: Malaysia, Singapore, Thailand, Hong Kong, Korea, China, Indonesia and Japan.

Offer: Fuze Ecoteer school camps, conservation expeditions, student volunteering, service-learning trips, outdoor education and Perhentian-based learning experiences.
...
Audience: corporate HR, CSR, ESG, sustainability, employee engagement and corporate communications teams.

Focus locations: Kuala Lumpur, Selangor, Kelantan, Terengganu and Pahang.

Offer: corporate team building with a cause, CSR impact days, ESG volunteering, conservation activities and employee engagement programmes.
...
- PTP: turtle conservation
- PMRS: marine research and reef/seagrass conservation
